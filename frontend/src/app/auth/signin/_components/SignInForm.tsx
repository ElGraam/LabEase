'use client';
import { Box, Button, FormControl, FormLabel, Heading, Input, Link, SystemStyleObject, Text, VStack } from '@chakra-ui/react';
      ...
      <Box as='form' onSubmit={handleSubmit} sx={formBoxStyle}>
        <VStack sx={formVStackStyle}>
          ...
          <FormControl isRequired>
            ...
            <Text sx={formSubLabelStyle}> 大学のドメインを使用してください。</Text>
            <Input placeholder='メールアドレス' type='email' id='email' name='email' />
          </FormControl>
          <FormControl isRequired>
