...
import { Heading, SystemStyleObject, Text, VStack, Button, Table, Thead, Tbody, Tr, Th, Td } from '@chakra-ui/react';
...
const StudentList = async ({
  ...
  const resultText = totalCount ? `${totalCount}件の学生が見つかりました` : '学生が見つかりませんでした';
