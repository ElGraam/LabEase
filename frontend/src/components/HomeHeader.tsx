'use client';
import { Box, Button, Flex, Heading, Image, SystemStyleObject } from '@chakra-ui/react';
  ...
  return (
    <Flex as='section' sx={flexStyle}>
      <Flex sx={mainImageFlexStyle}>
        <Image src='/homeHeaderImage.png' alt='univ photo' sx={mainImageStyle} />
      </Flex>
      <Flex sx={headerContentFlexStyle}>
        <Image src='/univ-logo.png' alt='univのロゴ' sx={serviceLogoImageStyle} />
